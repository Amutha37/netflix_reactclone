...
const requests = {
  fetchTrending: `/trending/all/week?language=en-US&api_key=${process.env.REACT_APP_TMDB_KEY}`,
  fetchNetflixOriginals: `/discover/tv?with_networks=213&api_key=${process.env.REACT_APP_TMDB_KEY}`,
